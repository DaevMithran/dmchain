...
import (
	...
	dmchainapp "github.com/DaevMithran/dmchain/app"
	appparams "github.com/DaevMithran/dmchain/app/params"
...
func NewTestMsgCreateValidator(address sdk.ValAddress, pubKey cryptotypes.PubKey, amt math.Int) *stakingtypes.MsgCreateValidator {
	...
	msg, _ := stakingtypes.NewMsgCreateValidator(
		address.String(), pubKey, sdk.NewCoin(types.DmDenom, amt),
