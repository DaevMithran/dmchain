...
const (
	Msg_AggregateExchangeRatePrevote_FullMethodName         = "/oracle.v1.Msg/AggregateExchangeRatePrevote"
	Msg_AggregateExchangeRateVote_FullMethodName            = "/oracle.v1.Msg/AggregateExchangeRateVote"
	Msg_DelegateFeedConsent_FullMethodName                  = "/oracle.v1.Msg/DelegateFeedConsent"
	Msg_LegacyGovUpdateParams_FullMethodName                = "/oracle.v1.Msg/LegacyGovUpdateParams"
	Msg_GovUpdateParams_FullMethodName                      = "/oracle.v1.Msg/GovUpdateParams"
	Msg_GovAddDenoms_FullMethodName                         = "/oracle.v1.Msg/GovAddDenoms"
	Msg_GovRemoveCurrencyPairProviders_FullMethodName       = "/oracle.v1.Msg/GovRemoveCurrencyPairProviders"
	Msg_GovRemoveCurrencyDeviationThresholds_FullMethodName = "/oracle.v1.Msg/GovRemoveCurrencyDeviationThresholds"
	Msg_GovCancelUpdateParamPlan_FullMethodName             = "/oracle.v1.Msg/GovCancelUpdateParamPlan"
)
...
func (c *msgClient) AggregateExchangeRatePrevote(ctx context.Context, in *MsgAggregateExchangeRatePrevote, opts ...grpc.CallOption) (*MsgAggregateExchangeRatePrevoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_AggregateExchangeRatePrevote_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AggregateExchangeRateVote(ctx context.Context, in *MsgAggregateExchangeRateVote, opts ...grpc.CallOption) (*MsgAggregateExchangeRateVoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_AggregateExchangeRateVote_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DelegateFeedConsent(ctx context.Context, in *MsgDelegateFeedConsent, opts ...grpc.CallOption) (*MsgDelegateFeedConsentResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_DelegateFeedConsent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) LegacyGovUpdateParams(ctx context.Context, in *MsgLegacyGovUpdateParams, opts ...grpc.CallOption) (*MsgLegacyGovUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_LegacyGovUpdateParams_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GovUpdateParams(ctx context.Context, in *MsgGovUpdateParams, opts ...grpc.CallOption) (*MsgGovUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_GovUpdateParams_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GovAddDenoms(ctx context.Context, in *MsgGovAddDenoms, opts ...grpc.CallOption) (*MsgGovAddDenomsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_GovAddDenoms_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GovRemoveCurrencyPairProviders(ctx context.Context, in *MsgGovRemoveCurrencyPairProviders, opts ...grpc.CallOption) (*MsgGovRemoveCurrencyPairProvidersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_GovRemoveCurrencyPairProviders_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GovRemoveCurrencyDeviationThresholds(ctx context.Context, in *MsgGovRemoveCurrencyDeviationThresholds, opts ...grpc.CallOption) (*MsgGovRemoveCurrencyDeviationThresholdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_GovRemoveCurrencyDeviationThresholds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GovCancelUpdateParamPlan(ctx context.Context, in *MsgGovCancelUpdateParamPlan, opts ...grpc.CallOption) (*MsgGovCancelUpdateParamPlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_GovCancelUpdateParamPlan_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
