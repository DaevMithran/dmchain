...
HTTPS_GIT := github.com/DaevMithran/cosmos-modules.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=multisig \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c multisig --local -f chains.yaml
endif
